...
- **Authentication**: NextAuth.js 4.24.7 with AWS Cognito provider + Google OAuth
...
- Tiered subscription model with Stripe integration:
  ...
  - **Core** ($7.99/mo or $79.99/year): Unlimited workouts, 5 OCR/week, 10 AI enhancements/month
...
- Usage tracking: `ocrQuotaUsed`, `workoutsSaved`, `aiRequestsUsed`
